...
def main(_):
    ...
    if FLAGS.visualize_reconstruct:
        ...
        dataVisualName1='mnist_(20x64)x32x32x1_unitLength1_test_visualdata1'
        dataVisualName2='mnist_(20x64)x32x32x1_unitLength1_test_visualdata2'
        ...
        for batch_num in range(int(sampleNum/FLAGS.batch_size)):
            ...
            ae2input.getVisualImgs(pathForSave,img_batch1, _mask1,img_batch2, _mask2,batch_num)
