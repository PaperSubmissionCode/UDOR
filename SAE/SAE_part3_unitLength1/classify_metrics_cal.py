...
unitlLength=1
data_npz_path='../../npz_datas/codes/codes_SAE_codesAndImgForMetricsCal.npz'
label_npz_path='../../npz_datas/mnistImgs_GTimages_mask_GTlabel_(47x64)x32x32x1_unitLength1_CodeImageDataset_forSAE.npz'
...
model_0.fit(data_train[:,0:unitlLength], train_label_0)
pre_0 = model_0.predict_proba(data_test[:,0:unitlLength])
pre1_0 = model_0.predict(data_test[:,0:unitlLength])
