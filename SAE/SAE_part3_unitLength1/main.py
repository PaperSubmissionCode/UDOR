...
flags.DEFINE_integer("epochs",5, "Number of epochs to train [25]")
...
def main(_):
    ...
    if FLAGS.train:
        ...
        data1Name='SAE_mnistMultiAndMaskAndLabels_unitLength_'+str(int(FLAGS.latent_dim/FLAGS.latent_num))+'_10000x32x32x1_train'
        ...
        data_manager = ShapesDataManager(dirs['data'],
                        ...
                        inf=True,supervised=True)  # supervised=True for get label
