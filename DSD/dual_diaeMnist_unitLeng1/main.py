...
def main(_):
    ...
    if FLAGS.train:
        ...
        data1Name='dataset1_255img32x32_mask_UnitLen_'+str(np.int32(FLAGS.latent_dim/3))+'supervised=0.5_N=5000'
        data2Name='dataset2_255img32x32_mask_UnitLen_'+str(np.int32(FLAGS.latent_dim/3))+'supervised=0.5_N=5000'
        data3Name='dataset3_255img32x32_mask_UnitLen_'+str(np.int32(FLAGS.latent_dim/3))+'supervised=0.5_N=5000'
        data4Name='dataset4_255img32x32_mask_UnitLen_'+str(np.int32(FLAGS.latent_dim/3))+'supervised=0.5_N=5000'
