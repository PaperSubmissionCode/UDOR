...
flags.DEFINE_integer("latent_dim", 4*1, "Number of latent variables [10]")
flags.DEFINE_integer("latent_num", 4, "Number of latent part")
...
def main(_):
    ...
    if FLAGS.visualize_reconstruct:
        ...
        dataVisualName1='fashion_(20x64)x32x32x1_unitLength1_test_visualdata1'
        dataVisualName2='fashion_(20x64)x32x32x1_unitLength1_test_visualdata2'
        ...
        saved_step = ae.load_fixedNum(1000)
