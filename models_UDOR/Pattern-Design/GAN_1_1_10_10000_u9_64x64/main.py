...
flags = tf.app.flags
flags.DEFINE_integer("epochs",10, "Number of epochs to train [25]")
...
flags.DEFINE_integer("latent_dim", 3*9, "Number of latent variables [10]") # todo: change with unitLength
flags.DEFINE_integer("latent_num", 3, "Number of latent part")
flags.DEFINE_integer("class_net_unit_num", 9, "Number of neuro cell") # todo: change with unitLength
flags.DEFINE_integer("batch_size", 64, "The size of training batches [64]")
flags.DEFINE_string("image_shape", "(3,64,64)", "Shape of inputs images [(1,32,32)]")
...
flags.DEFINE_float("lr", 0.001, "ratio value")
...
def main(_):
    ...
    if FLAGS.train:
        ...
        data1Name='Pattern_MultiAndMaskAndLabels_unitLength_9_10000x64x64x3_train'
