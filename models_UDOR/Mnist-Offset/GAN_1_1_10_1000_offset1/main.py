...
flags.DEFINE_integer("epochs",15, "Number of epochs to train [25]")
...
def main(_):
    ...
    if FLAGS.train:
        ...
        data1Name='unitLength1_mnistOffset1_PositionMultiAndMask_10000x32x32x1'
    ...
    data1Name="unitLength1_mnistOffset1_PositionMultiAndMask_64x32x32x1_valid"
